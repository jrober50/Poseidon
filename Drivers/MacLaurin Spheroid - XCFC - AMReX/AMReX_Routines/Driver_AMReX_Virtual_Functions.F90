...
!##!                                                                         !##!
!##!                                                                         !##!
MODULE Driver_AMReX_Virtual_Functions_Module                               !##!
!##!                                                                         !##!
...
USE Driver_AMReX_Tagging_Module, &
            ONLY : Tag_Source_Elements

USE Driver_AMReX_Patch_Module, &
            ONLY :  FillCoarsePatch,    &
                    FillPatch

USE Driver_Init_Data_On_Level_Module, &
...
END MODULE Driver_AMReX_Virtual_Functions_Module
