...
RE_Table            = (/ 3, 128, 160, 240, 320, 400, 600, 800, 1000 /)
...
Guess_Type          =  4            !  1 = Flat, 2 = Educated, 3 = Perturbed Educated.
...
NQ(2)               = 20                        ! Number of Theta Quadrature Points
NQ(3)               = 7                         ! Number of Phi Quadrature Points
...
!                            Local_Si, x_e                )
    ...
    ELSE IF (Guess_Type == 4 ) THEN
    
        CALL ReadIn_FP_Coeffs( NE(1), Degree_Input, 0, Suffix_Tail )
    ...
    IF (( Degree_Input == 1) .AND. (L_Limit_Input == 0 ) ) THEN
