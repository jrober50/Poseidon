...
!    Call Output_Laplace_Beta(Work_Mat, Beta_Prob_Dim, Beta_Prob_Dim, "B")
!    Call Output_Source_Beta( Work_Vec, Beta_Prob_Dim, "B")
...
!     Call Output_Coeffs_Beta( FP_Coeff_Vector_Beta, Beta_Prob_Dim, "B")
...
END MODULE Functions_FP_Solvers
