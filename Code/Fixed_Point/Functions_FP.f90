...
!+101+###########################################################################!
!                                                                                !
!                  Laplace_Test_Solution          !
!                                                                                !
!################################################################################!
FUNCTION Laplace_Test_Sol(r, theta, phi)


REAL(idp)                           ::  Laplace_Test_Sol
REAL(idp), INTENT(IN)               ::  r, theta, phi

REAL(idp)                           ::  C_One, C_Two
...
Laplace_Test_Sol = C_One*r + C_Two*(r)**(-2)

END FUNCTION Laplace_Test_Sol





END MODULE Functions_FP
