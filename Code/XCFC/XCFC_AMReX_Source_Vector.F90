...
!##!                                                                         !##!
!##!                                                                         !##!
MODULE XCFC_AMReX_Source_Vector_Module                                       !##!
!##!                                                                         !##!
...
!                                                                                !
!################################################################################!
SUBROUTINE XCFC_AMReX_Calc_X_Source()
...
CALL Calc_Int_Weights( DELTAR_OVERTWO, DELTAT_OVERTWO )

DO ui = 3,5
    CALL Get_Physical_Source( SourceTerm(:,:,ui+5), ui, re, te, pe )
END DO
...
DO lm_loc = 1,LM_LENGTH
    ...
    Current_i_Location = FP_X_Array_Map(re,d,ui,lm_loc)
...
#endif
END MODULE XCFC_AMReX_Source_Vector_Module
