...
!##!                                                                         !##!
!##!                                                                         !##!
MODULE Poseidon_Return_Routines_All                                           !##!
!##!                                                                         !##!
...
!                                                                                           !
!###########################################################################################!
SUBROUTINE Poseidon_Return_All_Native(  NE, NQ,                 &
                                        RQ_Input,               &
                                        TQ_Input,               &
                                        PQ_Input,               &
                                        Left_Limit,             &
...
REAL(idp),  DIMENSION(NQ(1)*NQ(2)*NQ(3),NE(1),NE(2),NE(3),1:11), INTENT(OUT) ::  Return_All
...
!                                                                                           !
!###########################################################################################!
SUBROUTINE Poseidon_Return_All_AMReX()
END SUBROUTINE Poseidon_Return_All_AMReX
...
!                                                                                           !
!###########################################################################################!
SUBROUTINE Poseidon_Return_All_AMReX_Caller( A_Difference )
...
END MODULE Poseidon_Return_Routines_ALL
